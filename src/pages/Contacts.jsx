        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            ...
            <div className="card mb-5 shadow-sm">
              <div className="row g-0 justify-content-center">
                <div className="col-md-3">
                  <img
                    src="https://images.unsplash.com/photo-1586769852836-bc069f19e1b6?auto=format&fit=crop&w=600&q=80"
                    className="img-fluid rounded-start h-100"
                    alt="Escritorio con laptop y cartel de contacto"
                ...
                <div className="col-md-7">
                  <div className="card-body p-3 d-flex flex-column justify-content-center">
                    ...
                    <p className="card-text">
                      ...
                      <strong>Email:</strong>{" "}
                      <a href="mailto:contacto@techstore.com">
            ...
            <div className="card p-4 shadow-sm">
              <h3 className="card-title mb-4">O déjanos un mensaje</h3>
